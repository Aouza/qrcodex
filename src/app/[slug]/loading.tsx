export default function PublicHubLoading() {
  return (
    <main className="public-hub public-menu__loading" role="status" aria-busy="true">
      ...
      <header className="public-hub__header" aria-hidden="true">
      ...
      <div className="public-hub__inner public-hub__loading-content" aria-hidden="true">
        <span className="public-menu__skeleton public-hub__skeleton-title" />
